...
import 'package:zebra_rfid_reader_sdk/src/zebra_rfid_reader_sdk.dart';
...
abstract class ZebraRfidReaderSdkPlatform extends PlatformInterface {
  ...
  /// Retrieves a list of Zebra RFID tags being readed.
  ///
  /// @throws [NotImplementedError] if the platform-specific implementation has not implemented this method.
  Future<List<dynamic>> getTagList() {
    throw UnimplementedError(
        'getTagList() has not been implemented.');
  }
