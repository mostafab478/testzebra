...
class ZebraConnectionHelper(
    ...
    ViewModel() {
    private val methodChannel = MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "zebra_rfid_reader")
    ...
    private fun configureReader(readerConfig: HashMap<String, Any>) {
        if (reader!!.isConnected) {
            ...
            try {
                ...
                rfidEventHandler = RfidEventHandler(reader!!, emit,methodChannel)
    ...
    /**
     * Retrieves the list of Tags being readed by reader device.
     *
     * @return The list of paired RFID readers.
     */
//    fun getTagList(): Array<TagData> {
//        return reader!!.Actions.getReadTags(100) ?: emptyArray<TagData>()
//    }
